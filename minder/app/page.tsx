...
// Step 4: add a "database" that keeps track of likes and dislikes. make it local. use redux store.
// Step 5: Implement swiping functionality (replacing like and dislike)
